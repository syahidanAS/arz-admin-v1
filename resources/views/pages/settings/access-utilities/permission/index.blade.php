        ...
        <div class="card table-responsive">
            <div class="card-header">
                ...
                <a class="btn btn-primary btn-sm col-sm-2"
                    href="{{ route('setting.access-utilities.permissions.create') }}">+
                    Tambah Data</a>
            </div>
            <div class="card-body">
...
<script>
    $(document).ready(function () {
        let table = $('#datatable').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('setting.access-utilities.permissions') }}",
    ...
    $(document).on('click', '.delete-item', function (event) {
        ...
        var url = '{{ route("setting.access-utilities.permissions.destroy", ":id") }}';
